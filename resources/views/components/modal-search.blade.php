        ...
        >
            ...
            <div class="py-4 px-2">
                ...
                <div class="mb-3 last:mb-0">
                    ...
                    <ul class="text-sm">
                        <li>
                            <a class="flex items-center p-2 text-slate-800 dark:text-slate-100 hover:text-white hover:bg-primary-500 rounded group" href="#0" @click="searchOpen = false" @focus="searchOpen = true" @focusout="searchOpen = false">
