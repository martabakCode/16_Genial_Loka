...
<div class="relative inline-flex" x-data="{ open: false }">
    ...
    >
        ...
        <ul>
            <li>
                <a class="font-medium text-sm text-primary-500 hover:text-primary-600 dark:hover:text-primary-400 flex items-center py-1 px-3" href="#0" @click="open = false" @focus="open = true" @focusout="open = false">
                    <svg class="w-3 h-3 fill-current text-primary-300 dark:text-primary-500 shrink-0 mr-2" viewBox="0 0 12 12">
